...
For Offensive Combat Styles, the number of damage dice it grants can be increased by 1 for a number of XP equal to $5 \times$ the new number of damage die (after the increase), so an increase from 1 die to 2 dice costs 10 XP.
