...
Attacks with this style deal 1d8 damage plus the bonus granted by this style (not including the Basic Statistic).
...
Attacks with this style deal 1d6 damage plus the bonus granted by this style (not including the Basic Statistic).
When you gain this Style, describe a new Experience (ideally related in some way to the character's combat abilities this style represents, for example related to knowledge of weapons, combat tactics, etc.); this Experience has a bonus equal to the attack bonus (not including the Basic Statistic) granted by this style.
\\
\underline{Upgrades:}
\begin{itemize}
...
Attacks with this style deal 1d4 damage plus the Specialization's bonus.
\\
\underline{Upgrades:}
\begin{itemize}
...
Attacks with this style deal 1d10 damage plus the Specialization's bonus.
\\
\underline{Upgrades:}
\begin{itemize}
...
\paragraph{Riposte}
Choose a Basic Statistic as the base bonus to defend.
When using this style, if the character is within range of the attacker, they can deal 1 damage to the attacker, regardless of the result of the roll.
\\
\underline{Upgrades}:
\begin{itemize}
  \item[-] The damage can be increased (to a maximum of 2 at character creation or 4 thereafter) for XP equal to the new amount of damage.
\end{itemize}
