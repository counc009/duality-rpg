...
Attacks with this style deal 1d4 damage plus the attack bonus (both the Basic statistic and the additional bonus).
\\
\underline{Upgrades:}
\begin{itemize}
...
Attacks with this style deal 1d10 damage plus the attack bonus (both the Basic statistic and the additional bonus).
\\
\underline{Upgrades:}
\begin{itemize}
