...
If the chosen Combat Style is Offensive, the item grants a $+1$ bonus to attack and damage.
If the chosen Combat Style is Defensive, the item grants a $+1$ bonus to defend.
