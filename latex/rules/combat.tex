...
If the result is \Mixed{} or worse then the target has the chance to strike back if it reasonably can; if it does it deals damage in the same manner based on the weapon used (and using one of its \emph{Combat Styles}), alternatively it can take \Advantage{} as usual.
