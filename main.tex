...
There are two three related \emph{Attributes}: \textbf{Life}\index{Life|seealso{Attribute}}, \textbf{Recovery}\index{Recovery|seealso{Attribute}}, and \textbf{Block}\index{Block|seealso{Attribute}}.
...
A character's \Life{} has a numeric score between 1 and 40, its \Recovery{} a numeric score between 1 and 20, and its \Block{} a numeric score between 0 and 2.
...
\begin{itemize}
  ...
  \item[-] Experience Points as money
