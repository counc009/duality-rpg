...
\begin{itemize}
  \item[-] \textbf{Melee}\index{Melee|see{Weapon}}: can be used to make a melee attack, dealing 1d8 base damage.
    A melee attack made without this keyword is \emph{Decreased}.
  \item[-] \textbf{Ranged}\index{Ranged|see{Weapon}}: can be used to make a ranged attack at a Close or Mid-Range distance, dealing 1d6 base damage.
    A ranged attack made without this keyword is \emph{Decreased}.
    A ranged attack beyond a Mid-Range is \emph{Decreased}.
  \item[-] \textbf{Accurate}\index{Accurate|see{Weapon}}: increases the base damage of a \emph{Ranged} weapon to 1d8.
  \item[-] \textbf{Defensive}\index{Defensive|see{Weapon}} grants a +1 bonus to \Block.
  \item[-] \textbf{Multihit}\index{Multihit|see{Weapon}}: you can spend advantage to target a creature and all those adjacent to it at -1 damage dice.
  \item[-] \textbf{Reach}\index{Reach|see{Weapon}}: increases the range of a melee attack to a Near distance.
  \item[-] \textbf{Far Shooter}\index{Far Shooter|see{Weapon}}: increases the range of a ranged attack to Far.
  \item[-] \textbf{Piercing}\index{Piercing|see{Weapon}}: you can spend advantage to ignore the target's \Block.
\end{itemize}

\section{Adventuring}
\subsection{Rest} {\color{red}\bf TODO}
\subsection{Defeat} {\color{red}\bf TODO}
...
\begin{table}
  ...
  \end{tabular}
  \caption{General Skills\index{Skill!General}}
