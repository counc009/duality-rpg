...
The target subtracts their \Block{} from this number and any remaining damage is subtracted from its \Life{}.
...
\begin{itemize}
  ...
  \item[-] \textbf{Defensive}: grants a +1 bonus to \Block.
  \item[-] \textbf{Multihit}: you can spend advantage to target a creature and all those adjacent to it at -1 damage dice.
  ...
  \item[-] \textbf{Piercing}: you can spend advantage to ignore the target's \Block.
\end{itemize}

\section{Adventuring}
\subsection{Rest} {\color{red}\bf TODO}
\subsection{Defeated} {\color{red}\bf TODO}
...
There are two three related \emph{Attributes}: \textbf{Life}, \textbf{Recovery}, and \textbf{Block}.
