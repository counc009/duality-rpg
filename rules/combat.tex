...
\begin{itemize}
  ...
  \item[-] \textbf{Unstable}: the creature remains alive but barely, with its fate hanging in the balance.
    ...
    At the end of each of its turns, it rolls \emph{Willpower} and must roll a \Mixed{} or better result with the \Difficulty{} of this roll initially \emph{Very Easy} and increasing by one level each round and each time the creature takes damage while in this state.
    If it fails one of these rolls, it dies.
    An \emph{Unstable} creature can be stabalized into \emph{Unconsciousness} by a successful \emph{Medium} \Difficulty{} roll.
\end{itemize}
