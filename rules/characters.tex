...
\begin{itemize}
  ...
  \item A character can add a Climb or Swim speed at \emph{Slow} for 6 XP, with it costing 1 XP to increase to \emph{Normal} and another 1 XP to increase to \emph{Fast}, a a Burrow speed at \emph{Slow} for 10 XP (with increasing speed costing the same), or a Fly speed for 16 XP (with increases costing the same).
