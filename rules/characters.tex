...
The damage die for attacks with this style is d8; and attacks with this style deal a base of 1 damage die.
...
The damage die for attacks with this style is d6; and attacks with this style deal a base of 1 damage die.
Describe a new Experience (ideally related in some way to the character's combat abilities this style represents, for example related to knowledge of weapons, combat tactics, etc.); this Experience has a bonus equal to the attack bonus (not including the Basic Statistic) granted by this style.
\\
\underline{Upgrades:}
\begin{itemize}
...
The damage die for attacks with this style is d4; and attacks with this style deal a base of 1 damage die.
\\
\underline{Upgrades:}
\begin{itemize}
...
The damage die for attacks with this style is d10; and attacks with this style deal a base of 1 damage die.
\\
\underline{Upgrades:}
\begin{itemize}
