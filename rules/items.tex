...
Some characters don't use weapons or armor, rather have innate abilities that allow them to fight.
To build such a character, you will still define these innate abilities as a weapon, but mark it as an \emph{Innate Weapon} which means there is not physical item the character must be in possession of to benefit from the item.
...
\begin{itemize}
  \item \textbf{Melee}: This weapon is used in hand-to-hand combat; choose the attack \Attribute{} based on the nature of the weapon, the Item grants a $+ 1$ bonus to attack and deals 1d8 damage.
  \item \textbf{Ranged}: This weapon is used in ranged combat (the range is ``whatever is reasonable''); choose the attack \Attribute{} based on the nature of the weapon, the Item grants a $+ 1$ bonus to attack and deals 1d6 damage.
...
\begin{itemize}
  \item To make a weapon an \emph{Innate Weapon} costs 1 XP
  \item To increase a bonus (to an \Attribute{} or \Specialization, to \Block{}, to rolls to attack or defend, or to an \Experience) costs a number of XP equal to the \emph{total bonus} the item will offer after the increase.
    ...
    The maximum bonus to an \Attribute{}, \Specialization, \Block, or \Experience{} is the same as it would be for the character themselves.
    The maximum bonus to attack or defend is the same as the maximum bonus to a \Specialization.
...
\begin{itemize}
  \item To add an additional option (Melee, Ranged, or Defensive) costs 2 XP \emph{but does not grant the roll bonuses} so adding Defensive to a Melee weapon does not grant a $+ 1$ to defend but does grant a $+ 1$ to \Block{} still.
  \item A weapon which is Ranged can be used at ``unreasonable range'' for 2 XP
  \item A weapon which is Melee can be used ``just outside the reach of a similarly sized creature'' for 4 XP
