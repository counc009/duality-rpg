...
\begin{itemize}
  ...
  \item \textbf{Innate}: For an \emph{Innate Weapon} pick Melee or Ranged for the weapon, and the weapon gains the range and damage die of that kind of basic weapon, but the \emph{Innate Weapon} does not grant any bonus to the attack.
\end{itemize}
